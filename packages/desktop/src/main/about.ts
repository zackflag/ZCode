...
const ABOUT_APPLICATION_NAME = "ZCode Open Audit";
...
> = {
  "zh-CN": {
    aboutTitle: "关于 ZCode Open Audit",
    versionLabel: "版本",
    okButtonLabel: "确定",
    optimizedForAppleSilicon: "已针对 Apple Silicon 优化。",
    copyright: (year) => `版权所有 © ${year} ZCode Open Audit。`,
  },
  "en-US": {
    aboutTitle: "About ZCode Open Audit",
    versionLabel: "version",
    okButtonLabel: "OK",
    optimizedForAppleSilicon: "Optimized for Apple Silicon.",
    copyright: (year) => `Copyright © ${year} ZCode Open Audit.`,
  },
};
