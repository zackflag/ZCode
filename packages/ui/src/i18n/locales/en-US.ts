...
const enUS: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "How would you like ZCode Open Audit to show its work?",
  ...
  "occupationOnboarding.memoryDescription":
    "Let ZCode Open Audit remember your preferences and work context.",
  ...
  "startup.global.silent": "Starting ZCode Open Audit",
  ...
  "startup.global.servicesFailed":
    "Local data is ready, but app services failed to start. Copy the diagnostics, then exit and reopen ZCode Open Audit.",
  ...
  "startup.global.starting_services": "Starting ZCode Open Audit",
  "startup.global.ready": "Local data is ready",
  "startup.global.failed": "Startup preparation failed",
  "startup.global.help":
    "ZCode Open Audit will open when preparation finishes. Large histories may take longer. Please keep the app running.",
  ...
  "startup.global.error.lock_timeout":
    "Waiting for the database write lock timed out. Another ZCode Open Audit or CLI process may be updating data. Retry after it finishes.",
  ...
  "startup.global.error.startup_status_timeout":
    "No startup status was received. Exit and reopen ZCode Open Audit. If it fails again, provide the diagnostics to support.",
  "startup.global.error.transport_closed":
    "The preparation process exited or disconnected. Exit and reopen ZCode Open Audit to check the migration records again.",
  "startup.global.error.unsupported_runtime":
    "The configured Agent does not support storage preparation. Restore the bundled Agent, then reopen ZCode Open Audit.",
  ...
  "settings.computerUse.disabledToast":
    "Computer Use is disabled. Existing conversations require a ZCode Open Audit restart to take effect.",
  ...
  "conversationShare.permission.linkEditorHint": "Import into ZCode Open Audit",
  ...
  "conversationShare.import.loginRequired":
    "This share cannot be imported anonymously. Sign in to ZCode Open Audit and try again",
  ...
  // Welcome / Login
  "welcome.title": "Welcome to ZCode Open Audit",
  "welcome.username": "Username",
  "welcome.password": "Password",
  "welcome.login": "Login",
  "welcome.loggingIn": "Logging in...",
  "welcome.loginFailed": "Login failed",
  "login.title": "Welcome to ZCode Open Audit",
  "login.description": "Connect your account to start using ZCode Open Audit",
  ...
  "logout.confirm.title": "Disconnect and restart ZCode Open Audit?",
  ...
  "modelTrajectory.empty": "No model calls recorded (only ZCode Open Audit Agent writes model-io)",
  ...
  "titleBar.menu.help.about": "About ZCode Open Audit",
  ...
  "forceUpdate.title": "Update ZCode Open Audit to continue",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "The workspace directory does not exist or cannot be accessed. You can only view history for now. Restore the directory and restart ZCode Open Audit to continue.",
  ...
  "ssh.assetInstallModeDescription":
    "Remote server download reduces upload waiting, but the server must reach the ZCode Open Audit CDN and have download, extract, and checksum tools.",
  ...
  "chat.changeSummary.rewindDialog.description":
    "ZCode Open Audit checks current file content again before writing. If another process changed a file, no files will be written.",
  ...
  "settings.terminalFontFamilyDescription":
    "Leave blank to auto-detect system terminal settings; set a value to override the ZCode Open Audit terminal font.",
  ...
  "settings.zcodeInteractionBehaviorDescription":
    "While ZCode Open Audit is running, add follow-up actions to the queue or guide them to run after the next tool call.",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "The data directory cannot be the ZCode Open Audit installation folder on Windows. Choose a folder outside the app install location.",
  ...
  "settings.migration.sectionDescription":
    "Scan native Claude Code history on this machine, optionally filter by workspace and activity window, then import the selected sessions into their matching ZCode Open Audit task lists.",
  ...
  "resourceManager.storage.summaryTotal": "Total used by ZCode Open Audit",
  ...
  "resourceManager.storage.diskUsage": "ZCode Open Audit uses {used}",
  ...
  "settings.browser.desktopOnly":
    "Browser data can only be managed in the ZCode Open Audit desktop app.",
  ...
  "settings.browser.import.helperVerificationFailed":
    "ZCode Open Audit could not verify its Windows secure import component. Reinstall or update ZCode Open Audit before importing cookies.",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome protects cookies with App-Bound encryption on Windows. For this import only, ZCode Open Audit will request administrator access, start a temporary system service, and delete it immediately afterward. Chrome passwords are never read or imported.",
  ...
  "settings.mcp.description": "Manage MCP server configurations used by ZCode Open Audit Agent.",
  ...
  "settings.mcp.host.activeDescription":
    "ZCode Open Audit provides this MCP server for the {pluginName} plugin. Its runtime identity is managed by the host.",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "This ZCode Open Audit Agent cannot refresh OAuth status. Upgrade or restart ZCode Open Audit, then reopen MCP settings to run a full refresh.",
  ...
  "settings.mcp.failure.not_authenticated":
    "You are not signed in. Sign in to ZCode Open Audit to use this MCP server.",
  ...
  "settings.mcpServers.import.importing": "Importing MCP servers into ZCode Open Audit",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description":
    "Timing starts after signing in to ZCode Open Audit 3.x.",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "Supports BYOK and BYOA. Base URL, API format, and API Key are maintained by ZCode Open Audit automatically.",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "Add yourself or other members on the BigModel team plan management page. Once assigned, the team quota will be available in ZCode Open Audit.",
  ...
  "settings.modelProvider.help.contextWindow":
    "The context capacity the model can process at once, in tokens. ZCode Open Audit uses this to manage context.\nDo not exceed the model's actual limit.",
  ...
  "settings.usage.billingBanner.description":
    "Connect your {provider} account to query Coding Plan entitlement, then keep coding in ZCode Open Audit after purchase or setup.",
  ...
  "settings.usage.entitlementServerMcpUsage": "ZCode Open Audit MCP",
  ...
  "sidebar.usage.plan.mcp": "ZCode Open Audit MCP",
  "sidebar.usage.plan.zcodeMcp": "ZCode Open Audit MCP",
  "sidebar.usage.plan.zcodeMcpDescription":
    "Daily aggregate quota for ZCode Open Audit built-in plugin MCPs",
  ...
  "settings.skills.import.mode.copy.description":
    "Copy the full skill directory into ZCode Open Audit. Later changes in the external agent directory will not sync automatically.",
  "settings.skills.import.mode.symlink.description":
    "Create a directory link to the external agent skill. ZCode Open Audit follows later source changes, but the skill depends on that source path remaining available.",
  "settings.skills.import.importing": "Importing skills into ZCode Open Audit",
  ...
  "settings.subagents.description":
    "Manage user-level subagent Markdown files consumed by ZCode Open Audit Agent.",
  ...
  "settings.plugins.store.subtitle":
    "Extend ZCode Open Audit with skills, commands, and MCP servers from plugins",
  ...
  "settings.plugins.import.mode.copy.description":
    "Copy the full plugin directory into ZCode Open Audit and register it in plugins.dirs. Later changes in the external agent directory will not sync automatically.",
  "settings.plugins.import.mode.symlink.description":
    "Create a directory link to the external agent plugin and register it in plugins.dirs. ZCode Open Audit follows later source changes, but the plugin depends on that source path remaining available.",
  "settings.plugins.import.importing": "Importing plugins into ZCode Open Audit",
  ...
  "settings.commands.description":
    "Manage ZCode Open Audit Agent .md command files. Commands can be invoked with /command-name in chat.",
  "settings.commands.sourceFilterLabel": "Source filter",
  "settings.commands.source.zcodeAgent": "ZCode Open Audit Agent",
  ...
  "settings.commands.import.mode.copy.description":
    "Copy the command file into ZCode Open Audit. Later changes in the external agent file will not sync automatically.",
  "settings.commands.import.mode.symlink.description":
    "Create a file link to the external agent command. ZCode Open Audit follows later source changes, but the command depends on that source path remaining available.",
  "settings.commands.import.importing": "Importing commands into ZCode Open Audit",
  ...
  "settingsSync.action.finish": "Start using ZCode Open Audit",
  "settingsSync.agent.zcode": "ZCode Open Audit Agent",
  ...
  "settingsSync.discovery.helper":
    "Only missing items will be imported and your current ZCode Open Audit settings will not be overwritten.",
  ...
  "onboarding.dialog.title": "Welcome to ZCode Open Audit",
  ...
  "onboarding.welcome.title": "Welcome to ZCode Open Audit",
  "onboarding.welcome.start": "Start ZCode Open Audit",
  ...
  "onboarding.stepDescription.migration":
    "Start migration and wait while ZCode Open Audit imports your selections.",
  ...
  "onboarding.agentsFile.confirmDescription":
    "ZCode Open Audit will copy {source} to {target}.\nIf the target file already exists, the ZCode Open Audit default AGENTS configuration will be overwritten.",
  ...
  "chat.placeholder.newTask":
    "Ask ZCode Open Audit anything, @ to add context, / for commands or capabilities",
  "chat.placeholder.newTaskMobile": "Ask ZCode Open Audit anything…",
  ...
  "chat.modelSwitch.contextWindowGuard.description":
    "This conversation has used {used} tokens, which exceeds {modelName}'s available context of {target} tokens after reserving maximum output.\nCompress the current conversation with the current model first. If the compressed context fits, ZCode Open Audit will continue switching models.",
  ...
  "chat.toolbar.computerUse.tooltip.ready":
    "Computer Use ready — just describe what you want ZCode Open Audit to do",
  ...
  "chat.toolbar.computerUse.tooltip.error":
    "Computer Use enablement failed. Please restart ZCode Open Audit app and retry, or ask ZCode Open Audit to investigate the logs",
  ...
  "workflows.hub.empty.hint":
    "Design a workflow with ZCode Open Audit in chat, then have it save the workflow to a project once it works. Projects that aren't open don't appear here.",
  ...
  "workflows.hub.detail.whenToUse.help":
    "A routing hint for ZCode Open Audit: when this workflow is the right pick.",
  ...
  "workflows.hub.detail.script.note":
    "The script is read-only. To change it, revise it with ZCode Open Audit in chat and save a new version.",
  ...
  "chat.slash.emptyUnavailable":
    "No slash commands have been broadcast for the current ZCode Open Audit Agent session",
  ...
  "chat.quota.mcp.quotaExhausted":
    'ZCode Open Audit MCP "{server}" has used up today\'s quota. It resets tomorrow.',
  "chat.quota.mcp.codingPlanRequired":
    'No ZCode Open Audit MCP "{server}" quota. Sign in or get a Coding Plan to use it.',
  ...
  "resourceManager.appUsage": "ZCode Open Audit",
  ...
  "feedback.submit.template.section.copyErrorHeading": "ZCode Open Audit Error Info",
  ...
  "offPeak.keepAwakeBanner": "Keep your computer awake while ZCode Open Audit is running a chat.",
  ...
  "offPeak.form.instructionsPlaceholder":
    "Describe a task ZCode Open Audit can work on in the background, including the expected result and any constraints…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "ZCode Open Audit Computer Use is still preparing — its tools aren't loaded yet ({count} loaded). Grant the permissions below; tools appear once the helper is ready.",
  "chat.cuaReadiness.toolsPreparing":
    "ZCode Open Audit Computer Use is still preparing — its tools aren't loaded yet. Grant the permissions below; tools appear once the helper is ready.",
  ...
  "cuaPermission.modal.relaunchAppButton": "Restart ZCode Open Audit",
  "cuaPermission.modal.relaunchAppHint":
    "Still not working after restarting Helper? Restart ZCode Open Audit to fully reload the Helper process.",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "Computer Use tools were found, but they did not come from the verified ZCode Open Audit plugin. Review the plugin installation, then check again.",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "ZCode Open Audit will verify the Computer Use tools against the exact session when your first session starts.",
