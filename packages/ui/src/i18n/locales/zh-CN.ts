...
const zhCN: Record<string, string> = {
  ...
  "login.title": "欢迎来到 ZCodium",
  "login.description": "连接账号，开始使用 ZCodium",
  ...
  "settings.officialServices.codingPlan.desc": "查询官方套餐、额度与用量。",
  "settings.officialServices.feedback.title": "官方反馈通道",
  "settings.officialServices.feedback.desc": "通过官方接口提交反馈；关闭时请到 GitHub Issues。",
  "settings.officialServices.officialMcp.title": "官方 MCP",
  "settings.officialServices.officialMcp.desc": "使用官方 MCP 凭证服务。",
  "settings.officialServices.offPeak.title": "闲时任务",
  "settings.officialServices.offPeak.desc": "使用官方闲时任务网关。",
  "settings.officialServices.marketplace.title": "官方插件市场与 CDN",
  ...
  "settings.mcp.failure.not_authenticated": "当前未登录，请先登录 ZCodium。",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "请先在 BigModel 团队套餐管理页添加自己或其他成员，完成后即可在 ZCodium 使用团队额度。",
  ...
  "settings.usage.billingBanner.description":
    "连接 {provider} 账号后查询编程套餐权益，购买或配置后回到 ZCodium 即可继续编码。",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "检测到电脑控制工具，但它们并非来自已校验的 ZCodium 官方插件。请检查插件安装后重新验证。",
