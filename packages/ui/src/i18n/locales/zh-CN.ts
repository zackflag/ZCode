...
const zhCN: Record<string, string> = {
  ...
  "settings.officialServices.account.title": "Z.AI 账号登录",
  "settings.officialServices.account.desc": "登录 Z.AI 账号并使用账号相关能力。",
  ...
  "settings.modelProvider.codingPlan.zaiOverseasPaymentRequired":
    "Z.ai 海外套餐需要通过 PayPal 或 Z.ai 支付页完成，不能使用支付宝签约流程。",
  ...
  "settings.modelProvider.codingPlan.paymentDialog.ruleDescription":
    "仅限订阅人在许可的产品范围内使用。严禁将账号出借、转让或以任何形式提供给第三方使用，亦不得用于非正当或违反法律法规及平台规则的行为。如发现平台将限制或封禁账号，且不予退款。",
